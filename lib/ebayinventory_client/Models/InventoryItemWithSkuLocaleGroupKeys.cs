...
namespace ebayinventory.Models
{
    ...
    /// <summary>
    /// This type is used to provide details about each retrieved inventory
    /// item record.
    /// </summary>
    public partial class InventoryItemWithSkuLocaleGroupKeys
    {
        ...
        /// InventoryItemWithSkuLocaleGroupKeys class.
        /// </summary>
        public InventoryItemWithSkuLocaleGroupKeys() { }

        /// <summary>
        /// Initializes a new instance of the
        /// InventoryItemWithSkuLocaleGroupKeys class.
        /// </summary>
        public InventoryItemWithSkuLocaleGroupKeys(Availability availability = default(Availability), string condition = default(string), string conditionDescription = default(string), IList<string> inventoryItemGroupKeys = default(IList<string>), string locale = default(string), PackageWeightAndSize packageWeightAndSize = default(PackageWeightAndSize), Product product = default(Product), string sku = default(string))
        {
