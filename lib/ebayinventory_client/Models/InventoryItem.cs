...
namespace ebayinventory.Models
{
    ...
    /// <summary>
    /// This type is used to provide detailed information about an inventory
    /// item.
    /// </summary>
    public partial class InventoryItem
    {
        ...
        /// Initializes a new instance of the InventoryItem class.
        /// </summary>
        public InventoryItem(Availability availability = default(Availability), string condition = default(string), string conditionDescription = default(string), PackageWeightAndSize packageWeightAndSize = default(PackageWeightAndSize), Product product = default(Product))
        {
        ...
        /// returned in the getInventoryItem and getInventoryItems calls if a
        /// condition description was provided for a used inventory item. Max
        /// Length: 1000.
        /// </summary>
